...
<head>
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Amar Seba","description":"Amar Seba provides All kinds of internet Services in One Place. We are here to serve you.","url":"https://amarseba.net/login"}</script>
    ...
    <style>
        .page_speed_2128504348 {
            font-size: 22px;
        }

        .page_speed_1073114608 {
            background-color: #2c3e50;
        }

        .page_speed_381549684 {
            text-decoration: none !important;
        }

        .page_speed_870724849 {
            height: 40px;
        }

        .page_speed_1890490711 {
            background: #2c3e50;
            border-radius: 10px;
        }

        .page_speed_148396478 {
            height: 120px;
            border-radius: 0%;
        }

        .page_speed_902363419 {
            max-width: 400px;
            margin: auto;
        }

        .page_speed_1209803116 {
            top: 10px;
            right: 12px;
            font-size: 12px;
        }

        .page_speed_1305602831 {
            display: none
        }
    </style>
</head>
...
@endif
                                        ...
                                        <form method="POST" action="{{ route('login') }}"
                                            class="form-horizontal mt-4 pt-2 text-left page_speed_902363419">
                                            @csrf

                                            <div class="mb-3">
                                                <input id="number" class="form-control" type="text"
                                                    placeholder="ফোন নাম্বার (ইংরেজিতে)" @error('number') is-invalid @enderror"
                                            ...
                                            <div class="mb-2 position-relative">
                                                <input id="password" class="form-control" type="password"
                                                    placeholder="পাসওয়ার্ড" @error('password') is-invalid @enderror"
                                                    name="password" required autocomplete="current-password" />
                                                <span
                                                    class="position-absolute badge bg-danger cursor-pointer showPass page_speed_1209803116">Show</span>
                                            </div>
