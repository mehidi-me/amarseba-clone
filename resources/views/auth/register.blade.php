...
<head>
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Amar Seba","description":"Amar Seba provides All kinds of internet Services in One Place. We are here to serve you.","url":"https://amarseba.net/register"}</script>
    ...
    <style>
        ...
        .page_speed_1808311317 {
            text-decoration: none !important;
        }

        .page_speed_1281770531 {
            height: 40px;
        }

        .page_speed_1724772321 {
            background: #2c3e50;
            border-radius: 10px;
        }

        .page_speed_1786824798 {
            height: 120px;
            border-radius: 0%;
        }

        .page_speed_1660960537 {
            top: 10px;
            right: 18px;
            font-size: 12px;
        }

        .page_speed_447558741 {
            display: none
        }
    </style>
</head>
                                ...
                                <div class="row justify-content-center">
                                    <div class="auth-form-wrapper px-4 py-3">
                                        <a href="#" class="noble-ui-logo d-block mb-2">
                                            <img src="admin-assets/images/logo.png" alt="image"
                                                class="page_speed_1786824798 ">
...
@endif
                                        ...
                                        <form class="form-horizontal mt-4 pt-2 px-2 mx-auto" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3 text-left">
                                                    <input type="tel" id="phone" class="form-control" 
                                                        name="number" 
                                                        placeholder="আপনার ফোন নাম্বার (ইংরেজিতে)" required />
                                                    <span id="phone_error_text"></span>
                                                </div>
                                                {{-- <div class="col-md-6 mb-3">
                                                    <input id="username" class="form-control" type="text"
                                                        name="username" value=""
                                                        placeholder="ইউজার নেইম (ইংরেজিতে)" required />
                                                </div> --}}

                                                <div class="col-md-6 mb-3 position-relative">
                                                    <input id="password" class="form-control" type="password"
                                                        name="password" placeholder="পাসওয়ার্ড (ইংরেজিতে)" required
                                                        autocomplete="new-password" />
                                                    <span
                                                        class="position-absolute badge bg-danger cursor-pointer showPass page_speed_1660960537">Show</span>
                                                </div>
                                               
                                                <div class="col-md-6 mb-3 position-relative">
                                                    <input id="password_confirmation" class="form-control"
                                                        type="password" name="password_confirmation"
                                                        placeholder="কনফার্ম পাসওয়ার্ড" required
                                                        autocomplete="new-password" />
                                                    <span
                                                        class="position-absolute badge bg-danger cursor-pointer showPass page_speed_1660960537">Show</span>
                                                </div>
                                                ...
                                                <div>
                                                    <button class="btn btn-success w-100 waves-effect waves-light"
                                                        type="submit">রেজিষ্ট্রেশন করুন</button>
                                                </div>
...
<script>
            ...
            axios.post('upazilas.html', {
                ...
                .then(res => {
                    if (res.data.length > 0) {
                        ...
                        $('#upazila_id').html(
                            '<option disabled selected>কোনো উপজেলা/থানা পাওয়া যায়নি</option>');
                    }
                })
                .catch(err => {
                    console.error(err);
    ...
    $('#phone').on('keyup', function(e) {
        ...
        if (phone.match(phoneno)) {
            ...
            $('#phone_error_text').html(
                '<small class="text-white text-left"> ফোন নাম্বার সঠিক নয়, ফরমেট: 01XXXXXXXXX </small>');
...
<form action="#" method="POST" id="delete-form" class="page_speed_447558741">
    <input type="hidden" name="_token" value="EHopzYsWO4y268nSQPu170NMBihqsINWCNIQl0PK"> <input type="hidden"
